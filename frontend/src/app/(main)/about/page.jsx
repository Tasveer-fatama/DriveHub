...
At [DriveHub], safety is our top priority. We maintain our vehicles to the highest standards and provide a variety of safety features to help keep you and your passengers safe on the road.</p>
                </div>
            ...
            <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 ">[DriveHub] was founded in [2024] by a group of travel enthusiasts who shared a common passion: exploring the world on their own terms. We were tired of the limitations of public transportation and the rigidity of guided tours. We craved the freedom to go wherever we wanted, whenever we wanted, and to experience the journey as much as the destination.

That's why we started [DriveHub]. We wanted to create a car rental service that was more than just a transaction. We wanted it to be an enabler of adventure, a key that unlocks new experiences and memories.</p>
                </div>
